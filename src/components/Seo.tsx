...
const defaultMeta = {
  title: 'greenbowl - Healthy green meals',
  siteName: 'greenbowl',
  description:
    'We serve healthy plant based meals to achieve your health goals. We are launching soon in vadodara',
  /** Without additional '/' on the end, e.g. https://theodorusclarence.com */
  url: 'https://getgreenbowl.com',
  type: 'website',
  robots: 'follow, index',
  /**
   ...
   */
  image: 'https://getgreenbowl.com/images/gb.jpg',
};
